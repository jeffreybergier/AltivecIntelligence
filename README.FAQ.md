...
| **Mac (Apple Silicon)** | Clang 14 | macOS 11.3 | arm64 | 11.0 Big Sur |
| **iPhone** | Clang 14 | iOS 8.4 | armv7, arm64 | iPhone 3GS+ iOS 4.3+ |
...
actually use 3 SDKs for the Mac version, but that is in the To-Do list for now.
