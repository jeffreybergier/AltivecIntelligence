...
| **Mac (Modern)** | OSXCross Clang 18 wrappers | 11.3 | x64, arm64 | 10.9 Mavericks+ |
| **iPhone** | Ubuntu Clang 18 + current cctools | 8.4 | armv7, arm64 | iPhone 3GS+ iOS 4.3+ |
...
make analyze
```
This will check for common issues like memory leaks, null pointer dereferences, and other logic errors using the modern Clang 18 toolchain.
